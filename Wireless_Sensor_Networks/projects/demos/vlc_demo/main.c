...
*
*******************************************************************************/
// Demo code. This code continuously sends out the data 0x69 (binary 01101001)
// Sync freq : 2k;;; ON freq : 3k;;; OFF freq : 8k
// Duty cycle matching has been done
// Images can be acquired at any time since it repeatedly sends out the bits
#include <nrk.h>
#include <include.h>
#include <ulib.h>
#include <stdio.h>
...
void Task2()
{
	...
	uint8_t bit,i;
	int8_t val;
	uint8_t tx_val=0x69;//binary 01101001
	uint8_t Nbits = 9;
	uint8_t index,ready;
